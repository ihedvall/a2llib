...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
    ...
    CONTROLLER_ADDRESSES = 314,    // CONTROLLER_ADDRESSES
    CONVERSION = 315,              // CONVERSION
    CPU_TYPE = 316,                // CPU_TYPE
    CURVE_AXIS_REF = 317,          // CURVE_AXIS_REF
    CUSTOMER = 318,                // CUSTOMER
    CUSTOMER_NO = 319,             // CUSTOMER_NO
    DATA_SIZE = 320,               // DATA_SIZE
    DEF_CHARACTERISTIC = 321,      // DEF_CHARACTERISTIC
    DEFAULT_VALUE = 322,           // DEFAULT_VALUE
    DEFAULT_VALUE_NUMERIC = 323,   // DEFAULT_VALUE_NUMERIC
    DEPENDENT_CHARACTERISTIC = 324, // DEPENDENT_CHARACTERISTIC
    DEPOSIT = 325,                 // DEPOSIT
    DISCRETE = 326,                // DISCRETE
    DISPLAY_IDENTIFIER = 327,      // DISPLAY_IDENTIFIER
    DIST_OP_X = 328,               // DIST_OP_X
    DIST_OP_Y = 329,               // DIST_OP_Y
    DIST_OP_Z = 330,               // DIST_OP_Z
    DIST_OP_4 = 331,               // DIST_OP_4
    DIST_OP_5 = 332,               // DIST_OP_5
    ECU = 333,                     // ECU
    ECU_ADDRESS = 334,             // ECU_ADDRESS
    ECU_ADDRESS_EXTENSION = 335,   // ECU_ADDRESS_EXTENSION
    ECU_CALIBRATION_OFFSET = 336,  // ECU_CALIBRATION_OFFSET
    ENCODING = 337,                // ENCODING
    EPK = 338,                     // EPK
    ERROR_MASK = 339,              // ERROR_MASK
    EXTENDED_LIMITS = 340,         // EXTENDED_LIMITS
    FIX_AXIS_PAR = 341,            // FIX_AXIS_PAR
    FIX_AXIS_PAR_DIST = 342,       // FIX_AXIS_PAR_DIST
    FIX_AXIS_PAR_LIST = 343,       // FIX_AXIS_PAR_LIST
    FIX_NO_AXIS_PTS_X = 344,       // FIX_NO_AXIS_PTS_X
    FIX_NO_AXIS_PTS_Y = 345,       // FIX_NO_AXIS_PTS_Y
    FIX_NO_AXIS_PTS_Z = 346,       // FIX_NO_AXIS_PTS_Z
    FIX_NO_AXIS_PTS_4 = 347,       // FIX_NO_AXIS_PTS_4
    FIX_NO_AXIS_PTS_5 = 348,       // FIX_NO_AXIS_PTS_5
    FNC_VALUES = 349,              // FNC_VALUES
    FORMAT = 350,                  // FORMAT
    FORMULA = 351,                 // FORMULA
    FORMULA_INV = 352,             // FORMULA_INV
    FRAME = 353,                   // FRAME
    FRAME_MEASUREMENT = 354,       // FRAME_MEASUREMENT
    FUNCTION = 355,                // FUNCTION
    FUNCTION_LIST = 356,           // FUNCTION_LIST
    FUNCTION_VERSION = 357,        // FUNCTION_VERSION
    GROUP = 358,                   // GROUP
    GUARD_RAILS = 359,             // GUARD_RAILS
    HEADER = 360,                  // HEADER
    IDENTIFICATION = 361,          // IDENTIFICATION
    IF_DATA = 362,                 // IF_DATA
    IN_MEASUREMENT = 363,          // IN_MEASUREMENT
    INPUT_QUANTITY = 364,          // INPUT_QUANTITY
    INSTANCE = 365,                // INSTANCE
    LAYOUT = 366,                  // LAYOUT
    LEFT_SHIFT = 367,              // LEFT_SHIFT
    LIMITS = 368,                  // LIMITS
    LOC_MEASUREMENT = 369,         // LOC_MEASUREMENT
    MAP_LIST = 370,                // MAP_LIST
    MATRIX_DIM = 371,              // MATRIX_DIM
    MAX_GRAD = 372,                // MAX_GRAD
    MAX_REFRESH = 373,             // MAX_REFRESH
    MEASUREMENT = 374,             // MEASUREMENT
    MEMORY_LAYOUT = 375,           // MEMORY_LAYOUT
    MEMORY_SEGMENT = 376,          // MEMORY_SEGMENT
    MODULE = 377,                  // MODULE
    MOD_COMMON = 378,              // MOD_COMMON
    MOD_PAR = 379,                 // MOD_PAR
    MODEL_LINK = 380,              // MODEL_LINK
    MONOTONY = 381,                // MONOTONY
    NO_AXIS_PTS_X = 382,           // NO_AXIS_PTS_X
    NO_AXIS_PTS_Y = 383,           // NO_AXIS_PTS_Y
    NO_AXIS_PTS_Z = 384,           // NO_AXIS_PTS_Z
    NO_AXIS_PTS_4 = 385,           // NO_AXIS_PTS_4
    NO_AXIS_PTS_5 = 386,           // NO_AXIS_PTS_5
    NO_OF_INTERFACES = 387,        // NO_OF_INTERFACES
    NO_RESCALE_X = 388,            // NO_RESCALE_X
    NUMBER = 389,                  // NUMBER
    OFFSET_X = 390,                // OFFSET_X
    OFFSET_Y = 391,                // OFFSET_Y
    OFFSET_Z = 392,                // OFFSET_Z
    OFFSET_4 = 393,                // OFFSET_4
    OFFSET_5 = 394,                // OFFSET_5
    OUT_MEASUREMENT = 395,         // OUT_MEASUREMENT
    OVERWRITE = 396,               // OVERWRITE
    PHONE_NO = 397,                // PHONE_NO
    PHYS_UNIT = 398,               // PHYS_UNIT
    PROJECT = 399,                 // PROJECT
    PROJECT_NO = 400,              // PROJECT_NO
    READ_ONLY = 401,               // READ_ONLY
    READ_WRITE = 402,              // READ_WRITE
    RECORD_LAYOUT = 403,           // RECORD_LAYOUT
    REF_CHARACTERISTIC = 404,      // REF_CHARACTERISTIC
    REF_GROUP = 405,               // REF_GROUP
    REF_MEASUREMENT = 406,         // REF_MEASUREMENT
    REF_MEMORY_SEGMENT = 407,      // REF_MEMORY_SEGMENT
    REF_UNIT = 408,                // REF_UNIT
    RESERVED = 409,                // RESERVED
    RIGHT_SHIFT = 410,             // RIGHT_SHIFT
    RIP_ADDR_W = 411,              // RIP_ADDR_W
    RIP_ADDR_X = 412,              // RIP_ADDR_X
    RIP_ADDR_Y = 413,              // RIP_ADDR_Y
    RIP_ADDR_Z = 414,              // RIP_ADDR_Z
    RIP_ADDR_4 = 415,              // RIP_ADDR_4
    RIP_ADDR_5 = 416,              // RIP_ADDR_5
    ROOT = 417,                    // ROOT
    S_REC_LAYOUT = 418,            // S_REC_LAYOUT
    SHIFT_OP_X = 419,              // SHIFT_OP_X
    SHIFT_OP_Y = 420,              // SHIFT_OP_Y
    SHIFT_OP_Z = 421,              // SHIFT_OP_Z
    SHIFT_OP_4 = 422,              // SHIFT_OP_4
    SHIFT_OP_5 = 423,              // SHIFT_OP_5
    SIGN_EXTEND = 424,             // SIGN_EXTEND
    SI_EXPONENTS = 425,            // SI_EXPONENTS
    SRC_ADDR_X = 426,              // SRC_ADDR_X
    SRC_ADDR_Y = 427,              // SRC_ADDR_Y
    SRC_ADDR_Z = 428,              // SRC_ADDR_Z
    SRC_ADDR_4 = 429,              // SRC_ADDR_4
    SRC_ADDR_5 = 430,              // SRC_ADDR_5
    STATIC_ADDRESS_OFFSETS = 431,  // STATIC_ADDRESS_OFFSETS
    STATIC_RECORD_LAYOUT = 432,    // STATIC_RECORD_LAYOUT
    STATUS_STRING_REF = 433,       // STATUS_STRING_REF
    STEP_SIZE = 434,               // STEP_SIZE
    STRUCTURE_COMPONENT = 435,     // STRUCTURE_COMPONENT
    SUB_FUNCTION = 436,            // SUB_FUNCTION
    SUB_GROUP = 437,               // SUB_GROUP
    SUPPLIER = 438,                // SUPPLIER
    SYMBOL_LINK = 439,             // SYMBOL_LINK
    SYMBOL_TYPE_LINK = 440,        // SYMBOL_TYPE_LINK
    SYSTEM_CONSTANT = 441,         // SYSTEM_CONSTANT
    TRANSFORMER = 442,             // TRANSFORMER
    TRANSFORMER_IN_OBJECTS = 443,  // TRANSFORMER_IN_OBJECTS
    TRANSFORMER_OUT_OBJECTS = 444, // TRANSFORMER_OUT_OBJECTS
    TYPEDEF_AXIS = 445,            // TYPEDEF_AXIS
    TYPEDEF_BLOB = 446,            // TYPEDEF_BLOB
    TYPEDEF_CHARACTERISTIC = 447,  // TYPEDEF_CHARACTERISTIC
    TYPEDEF_MEASUREMENT = 448,     // TYPEDEF_MEASUREMENT
    TYPEDEF_STRUCTURE = 449,       // TYPEDEF_STRUCTURE
    UNIT = 450,                    // UNIT
    UNIT_CONVERSION = 451,         // UNIT_CONVERSION
    USER = 452,                    // USER
    USER_RIGHTS = 453,             // USER_RIGHTS
    VAR_ADDRESS = 454,             // VAR_ADDRESS
    VAR_CHARACTERISTIC = 455,      // VAR_CHARACTERISTIC
    VAR_CRITERION = 456,           // VAR_CRITERION
    VAR_FORBIDDEN_COMB = 457,      // VAR_FORBIDDEN_COMB
    VAR_MEASUREMENT = 458,         // VAR_MEASUREMENT
    VAR_NAMING = 459,              // VAR_NAMING
    VAR_SELECTION_CHARACTERISTIC = 460, // VAR_SELECTION_CHARACTERISTIC
    VAR_SEPARATOR = 461,           // VAR_SEPARATOR
    VARIANT_CODING = 462,          // VARIANT_CODING
    VIRTUAL = 463,                 // VIRTUAL
    VIRTUAL_CHARACTERISTIC = 464   // VIRTUAL_CHARACTERISTIC
      };
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_CONTROLLER_ADDRESSES = 59,             // CONTROLLER_ADDRESSES
        S_CONVERSION = 60,                       // CONVERSION
        S_CPU_TYPE = 61,                         // CPU_TYPE
        S_CURVE_AXIS_REF = 62,                   // CURVE_AXIS_REF
        S_CUSTOMER = 63,                         // CUSTOMER
        S_CUSTOMER_NO = 64,                      // CUSTOMER_NO
        S_DATA_SIZE = 65,                        // DATA_SIZE
        S_DEF_CHARACTERISTIC = 66,               // DEF_CHARACTERISTIC
        S_DEFAULT_VALUE = 67,                    // DEFAULT_VALUE
        S_DEFAULT_VALUE_NUMERIC = 68,            // DEFAULT_VALUE_NUMERIC
        S_DEPENDENT_CHARACTERISTIC = 69,         // DEPENDENT_CHARACTERISTIC
        S_DEPOSIT = 70,                          // DEPOSIT
        S_DISCRETE = 71,                         // DISCRETE
        S_DISPLAY_IDENTIFIER = 72,               // DISPLAY_IDENTIFIER
        S_DIST_OP_X = 73,                        // DIST_OP_X
        S_DIST_OP_Y = 74,                        // DIST_OP_Y
        S_DIST_OP_Z = 75,                        // DIST_OP_Z
        S_DIST_OP_4 = 76,                        // DIST_OP_4
        S_DIST_OP_5 = 77,                        // DIST_OP_5
        S_ECU = 78,                              // ECU
        S_ECU_ADDRESS = 79,                      // ECU_ADDRESS
        S_ECU_ADDRESS_EXTENSION = 80,            // ECU_ADDRESS_EXTENSION
        S_ECU_CALIBRATION_OFFSET = 81,           // ECU_CALIBRATION_OFFSET
        S_ENCODING = 82,                         // ENCODING
        S_EPK = 83,                              // EPK
        S_ERROR_MASK = 84,                       // ERROR_MASK
        S_EXTENDED_LIMITS = 85,                  // EXTENDED_LIMITS
        S_FIX_AXIS_PAR = 86,                     // FIX_AXIS_PAR
        S_FIX_AXIS_PAR_DIST = 87,                // FIX_AXIS_PAR_DIST
        S_FIX_AXIS_PAR_LIST = 88,                // FIX_AXIS_PAR_LIST
        S_FIX_NO_AXIS_PTS_X = 89,                // FIX_NO_AXIS_PTS_X
        S_FIX_NO_AXIS_PTS_Y = 90,                // FIX_NO_AXIS_PTS_Y
        S_FIX_NO_AXIS_PTS_Z = 91,                // FIX_NO_AXIS_PTS_Z
        S_FIX_NO_AXIS_PTS_4 = 92,                // FIX_NO_AXIS_PTS_4
        S_FIX_NO_AXIS_PTS_5 = 93,                // FIX_NO_AXIS_PTS_5
        S_FNC_VALUES = 94,                       // FNC_VALUES
        S_FORMAT = 95,                           // FORMAT
        S_FORMULA = 96,                          // FORMULA
        S_FORMULA_INV = 97,                      // FORMULA_INV
        S_FRAME = 98,                            // FRAME
        S_FRAME_MEASUREMENT = 99,                // FRAME_MEASUREMENT
        S_FUNCTION = 100,                        // FUNCTION
        S_FUNCTION_LIST = 101,                   // FUNCTION_LIST
        S_FUNCTION_VERSION = 102,                // FUNCTION_VERSION
        S_GROUP = 103,                           // GROUP
        S_GUARD_RAILS = 104,                     // GUARD_RAILS
        S_HEADER = 105,                          // HEADER
        S_IDENTIFICATION = 106,                  // IDENTIFICATION
        S_IF_DATA = 107,                         // IF_DATA
        S_IN_MEASUREMENT = 108,                  // IN_MEASUREMENT
        S_INPUT_QUANTITY = 109,                  // INPUT_QUANTITY
        S_INSTANCE = 110,                        // INSTANCE
        S_LAYOUT = 111,                          // LAYOUT
        S_LEFT_SHIFT = 112,                      // LEFT_SHIFT
        S_LIMITS = 113,                          // LIMITS
        S_LOC_MEASUREMENT = 114,                 // LOC_MEASUREMENT
        S_MAP_LIST = 115,                        // MAP_LIST
        S_MATRIX_DIM = 116,                      // MATRIX_DIM
        S_MAX_GRAD = 117,                        // MAX_GRAD
        S_MAX_REFRESH = 118,                     // MAX_REFRESH
        S_MEASUREMENT = 119,                     // MEASUREMENT
        S_MEMORY_LAYOUT = 120,                   // MEMORY_LAYOUT
        S_MEMORY_SEGMENT = 121,                  // MEMORY_SEGMENT
        S_MODULE = 122,                          // MODULE
        S_MOD_COMMON = 123,                      // MOD_COMMON
        S_MOD_PAR = 124,                         // MOD_PAR
        S_MODEL_LINK = 125,                      // MODEL_LINK
        S_MONOTONY = 126,                        // MONOTONY
        S_NO_AXIS_PTS_X = 127,                   // NO_AXIS_PTS_X
        S_NO_AXIS_PTS_Y = 128,                   // NO_AXIS_PTS_Y
        S_NO_AXIS_PTS_Z = 129,                   // NO_AXIS_PTS_Z
        S_NO_AXIS_PTS_4 = 130,                   // NO_AXIS_PTS_4
        S_NO_AXIS_PTS_5 = 131,                   // NO_AXIS_PTS_5
        S_NO_OF_INTERFACES = 132,                // NO_OF_INTERFACES
        S_NO_RESCALE_X = 133,                    // NO_RESCALE_X
        S_NUMBER = 134,                          // NUMBER
        S_OFFSET_X = 135,                        // OFFSET_X
        S_OFFSET_Y = 136,                        // OFFSET_Y
        S_OFFSET_Z = 137,                        // OFFSET_Z
        S_OFFSET_4 = 138,                        // OFFSET_4
        S_OFFSET_5 = 139,                        // OFFSET_5
        S_OUT_MEASUREMENT = 140,                 // OUT_MEASUREMENT
        S_OVERWRITE = 141,                       // OVERWRITE
        S_PHONE_NO = 142,                        // PHONE_NO
        S_PHYS_UNIT = 143,                       // PHYS_UNIT
        S_PROJECT = 144,                         // PROJECT
        S_PROJECT_NO = 145,                      // PROJECT_NO
        S_READ_ONLY = 146,                       // READ_ONLY
        S_READ_WRITE = 147,                      // READ_WRITE
        S_RECORD_LAYOUT = 148,                   // RECORD_LAYOUT
        S_REF_CHARACTERISTIC = 149,              // REF_CHARACTERISTIC
        S_REF_GROUP = 150,                       // REF_GROUP
        S_REF_MEASUREMENT = 151,                 // REF_MEASUREMENT
        S_REF_MEMORY_SEGMENT = 152,              // REF_MEMORY_SEGMENT
        S_REF_UNIT = 153,                        // REF_UNIT
        S_RESERVED = 154,                        // RESERVED
        S_RIGHT_SHIFT = 155,                     // RIGHT_SHIFT
        S_RIP_ADDR_W = 156,                      // RIP_ADDR_W
        S_RIP_ADDR_X = 157,                      // RIP_ADDR_X
        S_RIP_ADDR_Y = 158,                      // RIP_ADDR_Y
        S_RIP_ADDR_Z = 159,                      // RIP_ADDR_Z
        S_RIP_ADDR_4 = 160,                      // RIP_ADDR_4
        S_RIP_ADDR_5 = 161,                      // RIP_ADDR_5
        S_ROOT = 162,                            // ROOT
        S_S_REC_LAYOUT = 163,                    // S_REC_LAYOUT
        S_SHIFT_OP_X = 164,                      // SHIFT_OP_X
        S_SHIFT_OP_Y = 165,                      // SHIFT_OP_Y
        S_SHIFT_OP_Z = 166,                      // SHIFT_OP_Z
        S_SHIFT_OP_4 = 167,                      // SHIFT_OP_4
        S_SHIFT_OP_5 = 168,                      // SHIFT_OP_5
        S_SIGN_EXTEND = 169,                     // SIGN_EXTEND
        S_SI_EXPONENTS = 170,                    // SI_EXPONENTS
        S_SRC_ADDR_X = 171,                      // SRC_ADDR_X
        S_SRC_ADDR_Y = 172,                      // SRC_ADDR_Y
        S_SRC_ADDR_Z = 173,                      // SRC_ADDR_Z
        S_SRC_ADDR_4 = 174,                      // SRC_ADDR_4
        S_SRC_ADDR_5 = 175,                      // SRC_ADDR_5
        S_STATIC_ADDRESS_OFFSETS = 176,          // STATIC_ADDRESS_OFFSETS
        S_STATIC_RECORD_LAYOUT = 177,            // STATIC_RECORD_LAYOUT
        S_STATUS_STRING_REF = 178,               // STATUS_STRING_REF
        S_STEP_SIZE = 179,                       // STEP_SIZE
        S_STRUCTURE_COMPONENT = 180,             // STRUCTURE_COMPONENT
        S_SUB_FUNCTION = 181,                    // SUB_FUNCTION
        S_SUB_GROUP = 182,                       // SUB_GROUP
        S_SUPPLIER = 183,                        // SUPPLIER
        S_SYMBOL_LINK = 184,                     // SYMBOL_LINK
        S_SYMBOL_TYPE_LINK = 185,                // SYMBOL_TYPE_LINK
        S_SYSTEM_CONSTANT = 186,                 // SYSTEM_CONSTANT
        S_TRANSFORMER = 187,                     // TRANSFORMER
        S_TRANSFORMER_IN_OBJECTS = 188,          // TRANSFORMER_IN_OBJECTS
        S_TRANSFORMER_OUT_OBJECTS = 189,         // TRANSFORMER_OUT_OBJECTS
        S_TYPEDEF_AXIS = 190,                    // TYPEDEF_AXIS
        S_TYPEDEF_BLOB = 191,                    // TYPEDEF_BLOB
        S_TYPEDEF_CHARACTERISTIC = 192,          // TYPEDEF_CHARACTERISTIC
        S_TYPEDEF_MEASUREMENT = 193,             // TYPEDEF_MEASUREMENT
        S_TYPEDEF_STRUCTURE = 194,               // TYPEDEF_STRUCTURE
        S_UNIT = 195,                            // UNIT
        S_UNIT_CONVERSION = 196,                 // UNIT_CONVERSION
        S_USER = 197,                            // USER
        S_USER_RIGHTS = 198,                     // USER_RIGHTS
        S_VAR_ADDRESS = 199,                     // VAR_ADDRESS
        S_VAR_CHARACTERISTIC = 200,              // VAR_CHARACTERISTIC
        S_VAR_CRITERION = 201,                   // VAR_CRITERION
        S_VAR_FORBIDDEN_COMB = 202,              // VAR_FORBIDDEN_COMB
        S_VAR_MEASUREMENT = 203,                 // VAR_MEASUREMENT
        S_VAR_NAMING = 204,                      // VAR_NAMING
        S_VAR_SELECTION_CHARACTERISTIC = 205,    // VAR_SELECTION_CHARACTERISTIC
        S_VAR_SEPARATOR = 206,                   // VAR_SEPARATOR
        S_VARIANT_CODING = 207,                  // VARIANT_CODING
        S_VIRTUAL = 208,                         // VIRTUAL
        S_VIRTUAL_CHARACTERISTIC = 209,          // VIRTUAL_CHARACTERISTIC
        S_YYACCEPT = 210,                        // $accept
        S_any_uint = 211,                        // any_uint
        S_any_int = 212,                         // any_int
        S_any_float = 213,                       // any_float
        S_int_list = 214,                        // int_list
        S_uint_list = 215,                       // uint_list
        S_float_list = 216,                      // float_list
        S_float_pair_list = 217,                 // float_pair_list
        S_float_string_list = 218,               // float_string_list
        S_float_range_list = 219,                // float_range_list
        S_string_list = 220,                     // string_list
        S_ident_or_keyword = 221,                // ident_or_keyword
        S_ident_list = 222,                      // ident_list
        S_key_value_list = 223,                  // key_value_list
        S_a2l_file = 224,                        // a2l_file
        S_file_version = 225,                    // file_version
        S_annotation = 226,                      // annotation
        S_annotation_attributes = 227,           // annotation_attributes
        S_annotation_text = 228,                 // annotation_text
        S_ar_component = 229,                    // ar_component
        S_ar_component_attribute = 230,          // ar_component_attribute
        S_axis_descr = 231,                      // axis_descr
        S_axis_descr_attributes = 232,           // axis_descr_attributes
        S_axis_descr_attribute = 233,            // axis_descr_attribute
        S_axis_pts = 234,                        // axis_pts
        S_axis_pts_attributes = 235,             // axis_pts_attributes
        S_axis_pts_attribute = 236,              // axis_pts_attribute
        S_bit_operation = 237,                   // bit_operation
        S_bit_operation_attributes = 238,        // bit_operation_attributes
        S_bit_operation_attribute = 239,         // bit_operation_attribute
        S_blob = 240,                            // blob
        S_blob_attributes = 241,                 // blob_attributes
        S_blob_attribute = 242,                  // blob_attribute
        S_calibration_handle = 243,              // calibration_handle
        S_calibration_handle_attribute = 244,    // calibration_handle_attribute
        S_calibration_method = 245,              // calibration_method
        S_calibration_method_attributes = 246,   // calibration_method_attributes
        S_characteristic = 247,                  // characteristic
        S_characteristic_attributes = 248,       // characteristic_attributes
        S_characteristic_attribute = 249,        // characteristic_attribute
        S_compu_method = 250,                    // compu_method
        S_compu_method_attributes = 251,         // compu_method_attributes
        S_compu_method_attribute = 252,          // compu_method_attribute
        S_compu_tab = 253,                       // compu_tab
        S_compu_tab_attributes = 254,            // compu_tab_attributes
        S_compu_tab_attribute = 255,             // compu_tab_attribute
        S_compu_vtab = 256,                      // compu_vtab
        S_compu_vtab_attributes = 257,           // compu_vtab_attributes
        S_compu_vtab_attribute = 258,            // compu_vtab_attribute
        S_compu_vtab_range = 259,                // compu_vtab_range
        S_compu_vtab_range_attributes = 260,     // compu_vtab_range_attributes
        S_compu_vtab_range_attribute = 261,      // compu_vtab_range_attribute
        S_controller_addresses = 262,            // controller_addresses
        S_controller_address_list = 263,         // controller_address_list
        S_controller_address = 264,              // controller_address
        S_def_characteristic = 265,              // def_characteristic
        S_dependent_characteristic = 266,        // dependent_characteristic
        S_fix_axis_par_list = 267,               // fix_axis_par_list
        S_formula = 268,                         // formula
        S_formula_attribute = 269,               // formula_attribute
        S_frame = 270,                           // frame
        S_frame_attributes = 271,                // frame_attributes
        S_frame_attribute = 272,                 // frame_attribute
        S_function = 273,                        // function
        S_function_attributes = 274,             // function_attributes
        S_function_attribute = 275,              // function_attribute
        S_function_list = 276,                   // function_list
        S_group = 277,                           // group
        S_group_attributes = 278,                // group_attributes
        S_group_attribute = 279,                 // group_attribute
        S_header = 280,                          // header
        S_header_attributes = 281,               // header_attributes
        S_header_attribute = 282,                // header_attribute
        S_in_measurement = 283,                  // in_measurement
        S_instance = 284,                        // instance
        S_instance_attributes = 285,             // instance_attributes
        S_instance_attribute = 286,              // instance_attribute
        S_loc_measurement = 287,                 // loc_measurement
        S_map_list = 288,                        // map_list
        S_measurement = 289,                     // measurement
        S_measurement_attributes = 290,          // measurement_attributes
        S_measurement_attribute = 291,           // measurement_attribute
        S_memory_layout = 292,                   // memory_layout
        S_memory_layout_attributes = 293,        // memory_layout_attributes
        S_prg_type = 294,                        // prg_type
        S_memory_segment = 295,                  // memory_segment
        S_memory_segment_attributes = 296,       // memory_segment_attributes
        S_mod_common = 297,                      // mod_common
        S_mod_common_attributes = 298,           // mod_common_attributes
        S_mod_common_attribute = 299,            // mod_common_attribute
        S_mod_par = 300,                         // mod_par
        S_mod_par_attributes = 301,              // mod_par_attributes
        S_mod_par_attribute = 302,               // mod_par_attribute
        S_module = 303,                          // module
        S_module_name = 304,                     // module_name
        S_module_comment = 305,                  // module_comment
        S_module_attributes = 306,               // module_attributes
        S_module_attribute = 307,                // module_attribute
        S_out_measurement = 308,                 // out_measurement
        S_overwrite = 309,                       // overwrite
        S_overwrite_attributes = 310,            // overwrite_attributes
        S_overwrite_attribute = 311,             // overwrite_attribute
        S_project = 312,                         // project
        S_project_attributes = 313,              // project_attributes
        S_project_attribute = 314,               // project_attribute
        S_record_layout = 315,                   // record_layout
        S_record_layout_attributes = 316,        // record_layout_attributes
        S_record_layout_attribute = 317,         // record_layout_attribute
        S_ref_characteristic = 318,              // ref_characteristic
        S_ref_group = 319,                       // ref_group
        S_ref_measurement = 320,                 // ref_measurement
        S_structure_component = 321,             // structure_component
        S_structure_component_attributes = 322,  // structure_component_attributes
        S_structure_component_attribute = 323,   // structure_component_attribute
        S_sub_function = 324,                    // sub_function
        S_sub_group = 325,                       // sub_group
        S_transformer = 326,                     // transformer
        S_transformer_attributes = 327,          // transformer_attributes
        S_transformer_attribute = 328,           // transformer_attribute
        S_transformer_in_objects = 329,          // transformer_in_objects
        S_transformer_out_objects = 330,         // transformer_out_objects
        S_typedef_axis = 331,                    // typedef_axis
        S_typedef_axis_attributes = 332,         // typedef_axis_attributes
        S_typedef_axis_attribute = 333,          // typedef_axis_attribute
        S_typedef_blob = 334,                    // typedef_blob
        S_typedef_blob_attributes = 335,         // typedef_blob_attributes
        S_typedef_blob_attribute = 336,          // typedef_blob_attribute
        S_typedef_characteristic = 337,          // typedef_characteristic
        S_typedef_characteristic_attributes = 338, // typedef_characteristic_attributes
        S_typedef_characteristic_attribute = 339, // typedef_characteristic_attribute
        S_typedef_measurement = 340,             // typedef_measurement
        S_typedef_measurement_attributes = 341,  // typedef_measurement_attributes
        S_typedef_measurement_attribute = 342,   // typedef_measurement_attribute
        S_typedef_structure = 343,               // typedef_structure
        S_typedef_structure_attributes = 344,    // typedef_structure_attributes
        S_typedef_structure_attribute = 345,     // typedef_structure_attribute
        S_unit = 346,                            // unit
        S_unit_attributes = 347,                 // unit_attributes
        S_unit_attribute = 348,                  // unit_attribute
        S_user_rights = 349,                     // user_rights
        S_user_rights_attributes = 350,          // user_rights_attributes
        S_user_rights_attribute = 351,           // user_rights_attribute
        S_var_address = 352,                     // var_address
        S_var_characteristic = 353,              // var_characteristic
        S_var_characteristic_attribute = 354,    // var_characteristic_attribute
        S_var_criterion = 355,                   // var_criterion
        S_var_criterion_attributes = 356,        // var_criterion_attributes
        S_var_criterion_attribute = 357,         // var_criterion_attribute
        S_var_forbidden_comb = 358,              // var_forbidden_comb
        S_variant_coding = 359,                  // variant_coding
        S_variant_coding_attributes = 360,       // variant_coding_attributes
        S_variant_coding_attribute = 361,        // variant_coding_attribute
        S_virtual = 362,                         // virtual
        S_virtual_characteristic = 363,          // virtual_characteristic
        S_a2ml = 364,                            // a2ml
        S_a2ml_version = 365,                    // a2ml_version
        S_asap2_version = 366,                   // asap2_version
        S_addr_epk = 367,                        // addr_epk
        S_address_type = 368,                    // address_type
        S_alignment_byte = 369,                  // alignment_byte
        S_alignment_float16_ieee = 370,          // alignment_float16_ieee
        S_alignment_float32_ieee = 371,          // alignment_float32_ieee
        S_alignment_float64_ieee = 372,          // alignment_float64_ieee
        S_alignment_int64 = 373,                 // alignment_int64
        S_alignment_long = 374,                  // alignment_long
        S_alignment_word = 375,                  // alignment_word
        S_annotation_label = 376,                // annotation_label
        S_annotation_origin = 377,               // annotation_origin
        S_array_size = 378,                      // array_size
        S_ar_prototype_of = 379,                 // ar_prototype_of
        S_axis_pts_ref = 380,                    // axis_pts_ref
        S_axis_pts_x = 381,                      // axis_pts_x
        S_axis_pts_y = 382,                      // axis_pts_y
        S_axis_pts_z = 383,                      // axis_pts_z
        S_axis_pts_4 = 384,                      // axis_pts_4
        S_axis_pts_5 = 385,                      // axis_pts_5
        S_axis_rescale_x = 386,                  // axis_rescale_x
        S_bit_mask = 387,                        // bit_mask
        S_byte_order = 388,                      // byte_order
        S_calibration_access = 389,              // calibration_access
        S_calibration_handle_text = 390,         // calibration_handle_text
        S_coeffs = 391,                          // coeffs
        S_coeffs_linear = 392,                   // coeffs_linear
        S_comparison_quantity = 393,             // comparison_quantity
        S_compu_tab_ref = 394,                   // compu_tab_ref
        S_consistent_exchange = 395,             // consistent_exchange
        S_conversion = 396,                      // conversion
        S_cpu_type = 397,                        // cpu_type
        S_curve_axis_ref = 398,                  // curve_axis_ref
        S_customer = 399,                        // customer
        S_customer_no = 400,                     // customer_no
        S_data_size = 401,                       // data_size
        S_default_value = 402,                   // default_value
        S_default_value_numeric = 403,           // default_value_numeric
        S_deposit = 404,                         // deposit
        S_discrete = 405,                        // discrete
        S_display_identifier = 406,              // display_identifier
        S_dist_op_x = 407,                       // dist_op_x
        S_dist_op_y = 408,                       // dist_op_y
        S_dist_op_z = 409,                       // dist_op_z
        S_dist_op_4 = 410,                       // dist_op_4
        S_dist_op_5 = 411,                       // dist_op_5
        S_ecu = 412,                             // ecu
        S_ecu_address = 413,                     // ecu_address
        S_ecu_address_extension = 414,           // ecu_address_extension
        S_ecu_calibration_offset = 415,          // ecu_calibration_offset
        S_encoding = 416,                        // encoding
        S_epk = 417,                             // epk
        S_error_mask = 418,                      // error_mask
        S_extended_limits = 419,                 // extended_limits
        S_fix_axis_par = 420,                    // fix_axis_par
        S_fix_axis_par_dist = 421,               // fix_axis_par_dist
        S_fix_no_axis_pts_x = 422,               // fix_no_axis_pts_x
        S_fix_no_axis_pts_y = 423,               // fix_no_axis_pts_y
        S_fix_no_axis_pts_z = 424,               // fix_no_axis_pts_z
        S_fix_no_axis_pts_4 = 425,               // fix_no_axis_pts_4
        S_fix_no_axis_pts_5 = 426,               // fix_no_axis_pts_5
        S_fnc_values = 427,                      // fnc_values
        S_format = 428,                          // format
        S_formula_inv = 429,                     // formula_inv
        S_frame_measurement = 430,               // frame_measurement
        S_function_version = 431,                // function_version
        S_guard_rails = 432,                     // guard_rails
        S_identification = 433,                  // identification
        S_if_data = 434,                         // if_data
        S_input_quantity = 435,                  // input_quantity
        S_layout = 436,                          // layout
        S_left_shift = 437,                      // left_shift
        S_limits = 438,                          // limits
        S_matrix_dim = 439,                      // matrix_dim
        S_max_grad = 440,                        // max_grad
        S_max_refresh = 441,                     // max_refresh
        S_model_link = 442,                      // model_link
        S_monotony = 443,                        // monotony
        S_no_axis_pts_x = 444,                   // no_axis_pts_x
        S_no_axis_pts_y = 445,                   // no_axis_pts_y
        S_no_axis_pts_z = 446,                   // no_axis_pts_z
        S_no_axis_pts_4 = 447,                   // no_axis_pts_4
        S_no_axis_pts_5 = 448,                   // no_axis_pts_5
        S_no_of_interfaces = 449,                // no_of_interfaces
        S_no_rescale_x = 450,                    // no_rescale_x
        S_number = 451,                          // number
        S_offset_x = 452,                        // offset_x
        S_offset_y = 453,                        // offset_y
        S_offset_z = 454,                        // offset_z
        S_offset_4 = 455,                        // offset_4
        S_offset_5 = 456,                        // offset_5
        S_phone_no = 457,                        // phone_no
        S_phys_unit = 458,                       // phys_unit
        S_proj_no = 459,                         // proj_no
        S_project_no = 460,                      // project_no
        S_read_only = 461,                       // read_only
        S_read_write = 462,                      // read_write
        S_ref_memory_segment = 463,              // ref_memory_segment
        S_ref_unit = 464,                        // ref_unit
        S_reserved = 465,                        // reserved
        S_right_shift = 466,                     // right_shift
        S_rip_addr_w = 467,                      // rip_addr_w
        S_rip_addr_x = 468,                      // rip_addr_x
        S_rip_addr_y = 469,                      // rip_addr_y
        S_rip_addr_z = 470,                      // rip_addr_z
        S_rip_addr_4 = 471,                      // rip_addr_4
        S_rip_addr_5 = 472,                      // rip_addr_5
        S_root = 473,                            // root
        S_s_rec_layout = 474,                    // s_rec_layout
        S_shift_op_x = 475,                      // shift_op_x
        S_shift_op_y = 476,                      // shift_op_y
        S_shift_op_z = 477,                      // shift_op_z
        S_shift_op_4 = 478,                      // shift_op_4
        S_shift_op_5 = 479,                      // shift_op_5
        S_sign_extend = 480,                     // sign_extend
        S_si_exponents = 481,                    // si_exponents
        S_src_addr_x = 482,                      // src_addr_x
        S_src_addr_y = 483,                      // src_addr_y
        S_src_addr_z = 484,                      // src_addr_z
        S_src_addr_4 = 485,                      // src_addr_4
        S_src_addr_5 = 486,                      // src_addr_5
        S_static_address_offsets = 487,          // static_address_offsets
        S_static_record_layout = 488,            // static_record_layout
        S_status_string_ref = 489,               // status_string_ref
        S_step_size = 490,                       // step_size
        S_supplier = 491,                        // supplier
        S_symbol_link = 492,                     // symbol_link
        S_symbol_type_link = 493,                // symbol_type_link
        S_system_constant = 494,                 // system_constant
        S_unit_conversion = 495,                 // unit_conversion
        S_user = 496,                            // user
        S_var_measurement = 497,                 // var_measurement
        S_var_naming = 498,                      // var_naming
        S_var_selection_characteristic = 499,    // var_selection_characteristic
        S_var_separator = 500,                   // var_separator
        S_version = 501                          // version
      };
    };
...
switch (yykind)
    ...
    // Implementation of make_symbol for each token kind.
      ...
      static
      symbol_type
      make_CONTROLLER_ADDRESSES ()
      {
        return symbol_type (token::CONTROLLER_ADDRESSES);
      }
#else
      static
      symbol_type
  ...
  private:
    ...
    enum
    {
      yylast_ = 1416,     ///< Last index in yytable_.
      yynnts_ = 292,  ///< Number of nonterminal symbols.
...
#line 6355 "D:/projects/a2llib/src/a2lparser.hpp"
