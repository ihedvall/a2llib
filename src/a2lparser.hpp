  ...
  private:
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_module = 302,                          // module
        S_module_attributes = 303,               // module_attributes
        S_module_attribute = 304,                // module_attribute
        S_out_measurement = 305,                 // out_measurement
        S_overwrite = 306,                       // overwrite
        S_overwrite_attributes = 307,            // overwrite_attributes
        S_overwrite_attribute = 308,             // overwrite_attribute
        S_project = 309,                         // project
        S_project_attributes = 310,              // project_attributes
        S_project_attribute = 311,               // project_attribute
        S_record_layout = 312,                   // record_layout
        S_record_layout_attributes = 313,        // record_layout_attributes
        S_record_layout_attribute = 314,         // record_layout_attribute
        S_ref_characteristic = 315,              // ref_characteristic
        S_ref_group = 316,                       // ref_group
        S_ref_measurement = 317,                 // ref_measurement
        S_structure_component = 318,             // structure_component
        S_structure_component_attributes = 319,  // structure_component_attributes
        S_structure_component_attribute = 320,   // structure_component_attribute
        S_sub_function = 321,                    // sub_function
        S_sub_group = 322,                       // sub_group
        S_transformer = 323,                     // transformer
        S_transformer_attributes = 324,          // transformer_attributes
        S_transformer_attribute = 325,           // transformer_attribute
        S_transformer_in_objects = 326,          // transformer_in_objects
        S_transformer_out_objects = 327,         // transformer_out_objects
        S_typedef_axis = 328,                    // typedef_axis
        S_typedef_axis_attributes = 329,         // typedef_axis_attributes
        S_typedef_axis_attribute = 330,          // typedef_axis_attribute
        S_typedef_blob = 331,                    // typedef_blob
        S_typedef_blob_attributes = 332,         // typedef_blob_attributes
        S_typedef_blob_attribute = 333,          // typedef_blob_attribute
        S_typedef_characteristic = 334,          // typedef_characteristic
        S_typedef_characteristic_attributes = 335, // typedef_characteristic_attributes
        S_typedef_characteristic_attribute = 336, // typedef_characteristic_attribute
        S_typedef_measurement = 337,             // typedef_measurement
        S_typedef_measurement_attributes = 338,  // typedef_measurement_attributes
        S_typedef_measurement_attribute = 339,   // typedef_measurement_attribute
        S_typedef_structure = 340,               // typedef_structure
        S_typedef_structure_attributes = 341,    // typedef_structure_attributes
        S_typedef_structure_attribute = 342,     // typedef_structure_attribute
        S_unit = 343,                            // unit
        S_unit_attributes = 344,                 // unit_attributes
        S_unit_attribute = 345,                  // unit_attribute
        S_user_rights = 346,                     // user_rights
        S_user_rights_attributes = 347,          // user_rights_attributes
        S_user_rights_attribute = 348,           // user_rights_attribute
        S_var_address = 349,                     // var_address
        S_var_characteristic = 350,              // var_characteristic
        S_var_characteristic_attribute = 351,    // var_characteristic_attribute
        S_var_criterion = 352,                   // var_criterion
        S_var_criterion_attributes = 353,        // var_criterion_attributes
        S_var_criterion_attribute = 354,         // var_criterion_attribute
        S_var_forbidden_comb = 355,              // var_forbidden_comb
        S_variant_coding = 356,                  // variant_coding
        S_variant_coding_attributes = 357,       // variant_coding_attributes
        S_variant_coding_attribute = 358,        // variant_coding_attribute
        S_virtual = 359,                         // virtual
        S_virtual_characteristic = 360,          // virtual_characteristic
        S_a2ml = 361,                            // a2ml
        S_a2ml_version = 362,                    // a2ml_version
        S_asap2_version = 363,                   // asap2_version
        S_addr_epk = 364,                        // addr_epk
        S_address_type = 365,                    // address_type
        S_alignment_byte = 366,                  // alignment_byte
        S_alignment_float16_ieee = 367,          // alignment_float16_ieee
        S_alignment_float32_ieee = 368,          // alignment_float32_ieee
        S_alignment_float64_ieee = 369,          // alignment_float64_ieee
        S_alignment_int64 = 370,                 // alignment_int64
        S_alignment_long = 371,                  // alignment_long
        S_alignment_word = 372,                  // alignment_word
        S_annotation_label = 373,                // annotation_label
        S_annotation_origin = 374,               // annotation_origin
        S_array_size = 375,                      // array_size
        S_ar_prototype_of = 376,                 // ar_prototype_of
        S_axis_pts_ref = 377,                    // axis_pts_ref
        S_axis_pts_x = 378,                      // axis_pts_x
        S_axis_pts_y = 379,                      // axis_pts_y
        S_axis_pts_z = 380,                      // axis_pts_z
        S_axis_pts_4 = 381,                      // axis_pts_4
        S_axis_pts_5 = 382,                      // axis_pts_5
        S_axis_rescale_x = 383,                  // axis_rescale_x
        S_bit_mask = 384,                        // bit_mask
        S_byte_order = 385,                      // byte_order
        S_calibration_access = 386,              // calibration_access
        S_calibration_handle_text = 387,         // calibration_handle_text
        S_coeffs = 388,                          // coeffs
        S_coeffs_linear = 389,                   // coeffs_linear
        S_comparison_quantity = 390,             // comparison_quantity
        S_compu_tab_ref = 391,                   // compu_tab_ref
        S_consistent_exchange = 392,             // consistent_exchange
        S_conversion = 393,                      // conversion
        S_cpu_type = 394,                        // cpu_type
        S_curve_axis_ref = 395,                  // curve_axis_ref
        S_customer = 396,                        // customer
        S_customer_no = 397,                     // customer_no
        S_data_size = 398,                       // data_size
        S_default_value = 399,                   // default_value
        S_default_value_numeric = 400,           // default_value_numeric
        S_deposit = 401,                         // deposit
        S_discrete = 402,                        // discrete
        S_display_identifier = 403,              // display_identifier
        S_dist_op_x = 404,                       // dist_op_x
        S_dist_op_y = 405,                       // dist_op_y
        S_dist_op_z = 406,                       // dist_op_z
        S_dist_op_4 = 407,                       // dist_op_4
        S_dist_op_5 = 408,                       // dist_op_5
        S_ecu = 409,                             // ecu
        S_ecu_address = 410,                     // ecu_address
        S_ecu_address_extension = 411,           // ecu_address_extension
        S_ecu_calibration_offset = 412,          // ecu_calibration_offset
        S_encoding = 413,                        // encoding
        S_epk = 414,                             // epk
        S_error_mask = 415,                      // error_mask
        S_extended_limits = 416,                 // extended_limits
        S_fix_axis_par = 417,                    // fix_axis_par
        S_fix_axis_par_dist = 418,               // fix_axis_par_dist
        S_fix_no_axis_pts_x = 419,               // fix_no_axis_pts_x
        S_fix_no_axis_pts_y = 420,               // fix_no_axis_pts_y
        S_fix_no_axis_pts_z = 421,               // fix_no_axis_pts_z
        S_fix_no_axis_pts_4 = 422,               // fix_no_axis_pts_4
        S_fix_no_axis_pts_5 = 423,               // fix_no_axis_pts_5
        S_fnc_values = 424,                      // fnc_values
        S_format = 425,                          // format
        S_formula_inv = 426,                     // formula_inv
        S_frame_measurement = 427,               // frame_measurement
        S_function_version = 428,                // function_version
        S_guard_rails = 429,                     // guard_rails
        S_identification = 430,                  // identification
        S_if_data = 431,                         // if_data
        S_input_quantity = 432,                  // input_quantity
        S_layout = 433,                          // layout
        S_left_shift = 434,                      // left_shift
        S_limits = 435,                          // limits
        S_matrix_dim = 436,                      // matrix_dim
        S_max_grad = 437,                        // max_grad
        S_max_refresh = 438,                     // max_refresh
        S_model_link = 439,                      // model_link
        S_monotony = 440,                        // monotony
        S_no_axis_pts_x = 441,                   // no_axis_pts_x
        S_no_axis_pts_y = 442,                   // no_axis_pts_y
        S_no_axis_pts_z = 443,                   // no_axis_pts_z
        S_no_axis_pts_4 = 444,                   // no_axis_pts_4
        S_no_axis_pts_5 = 445,                   // no_axis_pts_5
        S_no_of_interfaces = 446,                // no_of_interfaces
        S_no_rescale_x = 447,                    // no_rescale_x
        S_number = 448,                          // number
        S_offset_x = 449,                        // offset_x
        S_offset_y = 450,                        // offset_y
        S_offset_z = 451,                        // offset_z
        S_offset_4 = 452,                        // offset_4
        S_offset_5 = 453,                        // offset_5
        S_phone_no = 454,                        // phone_no
        S_phys_unit = 455,                       // phys_unit
        S_proj_no = 456,                         // proj_no
        S_project_no = 457,                      // project_no
        S_read_only = 458,                       // read_only
        S_read_write = 459,                      // read_write
        S_ref_memory_segment = 460,              // ref_memory_segment
        S_ref_unit = 461,                        // ref_unit
        S_reserved = 462,                        // reserved
        S_right_shift = 463,                     // right_shift
        S_rip_addr_w = 464,                      // rip_addr_w
        S_rip_addr_x = 465,                      // rip_addr_x
        S_rip_addr_y = 466,                      // rip_addr_y
        S_rip_addr_z = 467,                      // rip_addr_z
        S_rip_addr_4 = 468,                      // rip_addr_4
        S_rip_addr_5 = 469,                      // rip_addr_5
        S_root = 470,                            // root
        S_s_rec_layout = 471,                    // s_rec_layout
        S_shift_op_x = 472,                      // shift_op_x
        S_shift_op_y = 473,                      // shift_op_y
        S_shift_op_z = 474,                      // shift_op_z
        S_shift_op_4 = 475,                      // shift_op_4
        S_shift_op_5 = 476,                      // shift_op_5
        S_sign_extend = 477,                     // sign_extend
        S_si_exponents = 478,                    // si_exponents
        S_src_addr_x = 479,                      // src_addr_x
        S_src_addr_y = 480,                      // src_addr_y
        S_src_addr_z = 481,                      // src_addr_z
        S_src_addr_4 = 482,                      // src_addr_4
        S_src_addr_5 = 483,                      // src_addr_5
        S_static_address_offsets = 484,          // static_address_offsets
        S_static_record_layout = 485,            // static_record_layout
        S_status_string_ref = 486,               // status_string_ref
        S_step_size = 487,                       // step_size
        S_supplier = 488,                        // supplier
        S_symbol_link = 489,                     // symbol_link
        S_symbol_type_link = 490,                // symbol_type_link
        S_system_constant = 491,                 // system_constant
        S_unit_conversion = 492,                 // unit_conversion
        S_user = 493,                            // user
        S_var_measurement = 494,                 // var_measurement
        S_var_naming = 495,                      // var_naming
        S_var_selection_characteristic = 496,    // var_selection_characteristic
        S_var_separator = 497,                   // var_separator
        S_version = 498                          // version
      };
    };
...
switch (yykind)
  ...
  private:
    ...
    enum
    {
      yylast_ = 1278,     ///< Last index in yytable_.
