  ...
  private:
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_ident_list = 221,                      // ident_list
        S_key_value_list = 222,                  // key_value_list
        S_a2l_file = 223,                        // a2l_file
        S_file_version = 224,                    // file_version
        S_annotation = 225,                      // annotation
        S_annotation_attributes = 226,           // annotation_attributes
        S_annotation_text = 227,                 // annotation_text
        S_ar_component = 228,                    // ar_component
        ...
        S_controller_addresses = 261,            // controller_addresses
        S_controller_address_list = 262,         // controller_address_list
        S_controller_address = 263,              // controller_address
        S_def_characteristic = 264,              // def_characteristic
        S_dependent_characteristic = 265,        // dependent_characteristic
        S_fix_axis_par_list = 266,               // fix_axis_par_list
        S_formula = 267,                         // formula
        S_formula_attribute = 268,               // formula_attribute
        S_frame = 269,                           // frame
        S_frame_attributes = 270,                // frame_attributes
        S_frame_attribute = 271,                 // frame_attribute
        S_function = 272,                        // function
        S_function_attributes = 273,             // function_attributes
        S_function_attribute = 274,              // function_attribute
        S_function_list = 275,                   // function_list
        S_group = 276,                           // group
        S_group_attributes = 277,                // group_attributes
        S_group_attribute = 278,                 // group_attribute
        S_header = 279,                          // header
        S_header_attributes = 280,               // header_attributes
        S_header_attribute = 281,                // header_attribute
        S_in_measurement = 282,                  // in_measurement
        S_instance = 283,                        // instance
        S_instance_attributes = 284,             // instance_attributes
        S_instance_attribute = 285,              // instance_attribute
        S_loc_measurement = 286,                 // loc_measurement
        S_map_list = 287,                        // map_list
        S_measurement = 288,                     // measurement
        S_measurement_attributes = 289,          // measurement_attributes
        S_measurement_attribute = 290,           // measurement_attribute
        S_memory_layout = 291,                   // memory_layout
        S_memory_layout_attributes = 292,        // memory_layout_attributes
        S_prg_type = 293,                        // prg_type
        S_memory_segment = 294,                  // memory_segment
        S_memory_segment_attributes = 295,       // memory_segment_attributes
        S_mod_common = 296,                      // mod_common
        S_mod_common_attributes = 297,           // mod_common_attributes
        S_mod_common_attribute = 298,            // mod_common_attribute
        S_mod_par = 299,                         // mod_par
        S_mod_par_attributes = 300,              // mod_par_attributes
        S_mod_par_attribute = 301,               // mod_par_attribute
        S_module = 302,                          // module
        S_module_name = 303,                     // module_name
        S_module_comment = 304,                  // module_comment
        S_module_attributes = 305,               // module_attributes
        S_module_attribute = 306,                // module_attribute
        S_out_measurement = 307,                 // out_measurement
        S_overwrite = 308,                       // overwrite
        S_overwrite_attributes = 309,            // overwrite_attributes
        S_overwrite_attribute = 310,             // overwrite_attribute
        S_project = 311,                         // project
        S_project_attributes = 312,              // project_attributes
        S_project_attribute = 313,               // project_attribute
        S_record_layout = 314,                   // record_layout
        S_record_layout_attributes = 315,        // record_layout_attributes
        S_record_layout_attribute = 316,         // record_layout_attribute
        S_ref_characteristic = 317,              // ref_characteristic
        S_ref_group = 318,                       // ref_group
        S_ref_measurement = 319,                 // ref_measurement
        S_structure_component = 320,             // structure_component
        S_structure_component_attributes = 321,  // structure_component_attributes
        S_structure_component_attribute = 322,   // structure_component_attribute
        S_sub_function = 323,                    // sub_function
        S_sub_group = 324,                       // sub_group
        S_transformer = 325,                     // transformer
        S_transformer_attributes = 326,          // transformer_attributes
        S_transformer_attribute = 327,           // transformer_attribute
        S_transformer_in_objects = 328,          // transformer_in_objects
        S_transformer_out_objects = 329,         // transformer_out_objects
        S_typedef_axis = 330,                    // typedef_axis
        S_typedef_axis_attributes = 331,         // typedef_axis_attributes
        S_typedef_axis_attribute = 332,          // typedef_axis_attribute
        S_typedef_blob = 333,                    // typedef_blob
        S_typedef_blob_attributes = 334,         // typedef_blob_attributes
        S_typedef_blob_attribute = 335,          // typedef_blob_attribute
        S_typedef_characteristic = 336,          // typedef_characteristic
        S_typedef_characteristic_attributes = 337, // typedef_characteristic_attributes
        S_typedef_characteristic_attribute = 338, // typedef_characteristic_attribute
        S_typedef_measurement = 339,             // typedef_measurement
        S_typedef_measurement_attributes = 340,  // typedef_measurement_attributes
        S_typedef_measurement_attribute = 341,   // typedef_measurement_attribute
        S_typedef_structure = 342,               // typedef_structure
        S_typedef_structure_attributes = 343,    // typedef_structure_attributes
        S_typedef_structure_attribute = 344,     // typedef_structure_attribute
        S_unit = 345,                            // unit
        S_unit_attributes = 346,                 // unit_attributes
        S_unit_attribute = 347,                  // unit_attribute
        S_user_rights = 348,                     // user_rights
        S_user_rights_attributes = 349,          // user_rights_attributes
        S_user_rights_attribute = 350,           // user_rights_attribute
        S_var_address = 351,                     // var_address
        S_var_characteristic = 352,              // var_characteristic
        S_var_characteristic_attribute = 353,    // var_characteristic_attribute
        S_var_criterion = 354,                   // var_criterion
        S_var_criterion_attributes = 355,        // var_criterion_attributes
        S_var_criterion_attribute = 356,         // var_criterion_attribute
        S_var_forbidden_comb = 357,              // var_forbidden_comb
        S_variant_coding = 358,                  // variant_coding
        S_variant_coding_attributes = 359,       // variant_coding_attributes
        S_variant_coding_attribute = 360,        // variant_coding_attribute
        S_virtual = 361,                         // virtual
        S_virtual_characteristic = 362,          // virtual_characteristic
        S_a2ml = 363,                            // a2ml
        S_a2ml_version = 364,                    // a2ml_version
        S_asap2_version = 365,                   // asap2_version
        S_addr_epk = 366,                        // addr_epk
        S_address_type = 367,                    // address_type
        S_alignment_byte = 368,                  // alignment_byte
        S_alignment_float16_ieee = 369,          // alignment_float16_ieee
        S_alignment_float32_ieee = 370,          // alignment_float32_ieee
        S_alignment_float64_ieee = 371,          // alignment_float64_ieee
        S_alignment_int64 = 372,                 // alignment_int64
        S_alignment_long = 373,                  // alignment_long
        S_alignment_word = 374,                  // alignment_word
        S_annotation_label = 375,                // annotation_label
        S_annotation_origin = 376,               // annotation_origin
        S_array_size = 377,                      // array_size
        S_ar_prototype_of = 378,                 // ar_prototype_of
        S_axis_pts_ref = 379,                    // axis_pts_ref
        S_axis_pts_x = 380,                      // axis_pts_x
        S_axis_pts_y = 381,                      // axis_pts_y
        S_axis_pts_z = 382,                      // axis_pts_z
        S_axis_pts_4 = 383,                      // axis_pts_4
        S_axis_pts_5 = 384,                      // axis_pts_5
        S_axis_rescale_x = 385,                  // axis_rescale_x
        S_bit_mask = 386,                        // bit_mask
        S_byte_order = 387,                      // byte_order
        S_calibration_access = 388,              // calibration_access
        S_calibration_handle_text = 389,         // calibration_handle_text
        S_coeffs = 390,                          // coeffs
        S_coeffs_linear = 391,                   // coeffs_linear
        S_comparison_quantity = 392,             // comparison_quantity
        S_compu_tab_ref = 393,                   // compu_tab_ref
        S_consistent_exchange = 394,             // consistent_exchange
        S_conversion = 395,                      // conversion
        S_cpu_type = 396,                        // cpu_type
        S_curve_axis_ref = 397,                  // curve_axis_ref
        S_customer = 398,                        // customer
        S_customer_no = 399,                     // customer_no
        S_data_size = 400,                       // data_size
        S_default_value = 401,                   // default_value
        S_default_value_numeric = 402,           // default_value_numeric
        S_deposit = 403,                         // deposit
        S_discrete = 404,                        // discrete
        S_display_identifier = 405,              // display_identifier
        S_dist_op_x = 406,                       // dist_op_x
        S_dist_op_y = 407,                       // dist_op_y
        S_dist_op_z = 408,                       // dist_op_z
        S_dist_op_4 = 409,                       // dist_op_4
        S_dist_op_5 = 410,                       // dist_op_5
        S_ecu = 411,                             // ecu
        S_ecu_address = 412,                     // ecu_address
        S_ecu_address_extension = 413,           // ecu_address_extension
        S_ecu_calibration_offset = 414,          // ecu_calibration_offset
        S_encoding = 415,                        // encoding
        S_epk = 416,                             // epk
        S_error_mask = 417,                      // error_mask
        S_extended_limits = 418,                 // extended_limits
        S_fix_axis_par = 419,                    // fix_axis_par
        S_fix_axis_par_dist = 420,               // fix_axis_par_dist
        S_fix_no_axis_pts_x = 421,               // fix_no_axis_pts_x
        S_fix_no_axis_pts_y = 422,               // fix_no_axis_pts_y
        S_fix_no_axis_pts_z = 423,               // fix_no_axis_pts_z
        S_fix_no_axis_pts_4 = 424,               // fix_no_axis_pts_4
        S_fix_no_axis_pts_5 = 425,               // fix_no_axis_pts_5
        S_fnc_values = 426,                      // fnc_values
        S_format = 427,                          // format
        S_formula_inv = 428,                     // formula_inv
        S_frame_measurement = 429,               // frame_measurement
        S_function_version = 430,                // function_version
        S_guard_rails = 431,                     // guard_rails
        S_identification = 432,                  // identification
        S_if_data = 433,                         // if_data
        S_input_quantity = 434,                  // input_quantity
        S_layout = 435,                          // layout
        S_left_shift = 436,                      // left_shift
        S_limits = 437,                          // limits
        S_matrix_dim = 438,                      // matrix_dim
        S_max_grad = 439,                        // max_grad
        S_max_refresh = 440,                     // max_refresh
        S_model_link = 441,                      // model_link
        S_monotony = 442,                        // monotony
        S_no_axis_pts_x = 443,                   // no_axis_pts_x
        S_no_axis_pts_y = 444,                   // no_axis_pts_y
        S_no_axis_pts_z = 445,                   // no_axis_pts_z
        S_no_axis_pts_4 = 446,                   // no_axis_pts_4
        S_no_axis_pts_5 = 447,                   // no_axis_pts_5
        S_no_of_interfaces = 448,                // no_of_interfaces
        S_no_rescale_x = 449,                    // no_rescale_x
        S_number = 450,                          // number
        S_offset_x = 451,                        // offset_x
        S_offset_y = 452,                        // offset_y
        S_offset_z = 453,                        // offset_z
        S_offset_4 = 454,                        // offset_4
        S_offset_5 = 455,                        // offset_5
        S_phone_no = 456,                        // phone_no
        S_phys_unit = 457,                       // phys_unit
        S_proj_no = 458,                         // proj_no
        S_project_no = 459,                      // project_no
        S_read_only = 460,                       // read_only
        S_read_write = 461,                      // read_write
        S_ref_memory_segment = 462,              // ref_memory_segment
        S_ref_unit = 463,                        // ref_unit
        S_reserved = 464,                        // reserved
        S_right_shift = 465,                     // right_shift
        S_rip_addr_w = 466,                      // rip_addr_w
        S_rip_addr_x = 467,                      // rip_addr_x
        S_rip_addr_y = 468,                      // rip_addr_y
        S_rip_addr_z = 469,                      // rip_addr_z
        S_rip_addr_4 = 470,                      // rip_addr_4
        S_rip_addr_5 = 471,                      // rip_addr_5
        S_root = 472,                            // root
        S_s_rec_layout = 473,                    // s_rec_layout
        S_shift_op_x = 474,                      // shift_op_x
        S_shift_op_y = 475,                      // shift_op_y
        S_shift_op_z = 476,                      // shift_op_z
        S_shift_op_4 = 477,                      // shift_op_4
        S_shift_op_5 = 478,                      // shift_op_5
        S_sign_extend = 479,                     // sign_extend
        S_si_exponents = 480,                    // si_exponents
        S_src_addr_x = 481,                      // src_addr_x
        S_src_addr_y = 482,                      // src_addr_y
        S_src_addr_z = 483,                      // src_addr_z
        S_src_addr_4 = 484,                      // src_addr_4
        S_src_addr_5 = 485,                      // src_addr_5
        S_static_address_offsets = 486,          // static_address_offsets
        S_static_record_layout = 487,            // static_record_layout
        S_status_string_ref = 488,               // status_string_ref
        S_step_size = 489,                       // step_size
        S_supplier = 490,                        // supplier
        S_symbol_link = 491,                     // symbol_link
        S_symbol_type_link = 492,                // symbol_type_link
        S_system_constant = 493,                 // system_constant
        S_unit_conversion = 494,                 // unit_conversion
        S_user = 495,                            // user
        S_var_measurement = 496,                 // var_measurement
        S_var_naming = 497,                      // var_naming
        S_var_selection_characteristic = 498,    // var_selection_characteristic
        S_var_separator = 499,                   // var_separator
        S_version = 500                          // version
      };
    };
...
switch (yykind)
  ...
  private:
    ...
    enum
    {
      ...
      yynnts_ = 291,  ///< Number of nonterminal symbols.
...
#line 6351 "D:/projects/a2llib/src/a2lparser.hpp"
